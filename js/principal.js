...
555 ($40, $50), 444 ($80, $100) y 222 ($5, $10) 
Ganancia Total: 85$ 
...
salida.innerHTML+="<br> Ganancia Total: "+tienda.devolverAcumGt()+"$";
salida.innerHTML+="<br>Código del articulo con mayor precio de venta: "+tienda.devolverAuxCod();